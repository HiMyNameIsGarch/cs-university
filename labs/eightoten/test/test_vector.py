...
class Test_Vector(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.iv.set_value([1,1])
        self.mv.set_value([2,2])
        self.iv.add([1,1])
